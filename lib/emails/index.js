...
[
  ...
  "step-jumio-id2",     "step-jumio-id2-CN",     "step-jumio-id2-JP",     "step-jumio-id2-KR",
  "step-jumio-com-id", "step-jumio-com-id-CN", "step-jumio-com-id-JP", "step-jumio-com-id-KR"
  ...
  json.push({
    "type": "small",
    "text": "\nYou are receiving this email because you created a iCloud account.\t"
          + "If you did not sign up for a iCloud account, please disregard this email.",
  });
  json.push({type: "hr"});
  json.push({
    "type": "small",
    "text": "Need help? Contact support@icloud.com",
  });
